...
class Home(models.Model):
    ...
    descricao_quadrado_um = models.TextField(
        max_length=200, verbose_name='Descrição do quadrado 1', blank=True, null=True, default=' ')
    ...
    descricao_quadrado_dois = models.TextField(
        max_length=200, verbose_name='Descrição do quadrado 2', blank=True, null=True, default=' ')
    ...
    descricao_quadrado_tres = models.TextField(
        max_length=200, verbose_name='Descrição do quadrado 3', blank=True, null=True, default=' ')
    titulo_quadrado_quatro = models.CharField(
        max_length=50, verbose_name='Título do quadrado 4', blank=True, null=True, default=' ')
    descricao_quadrado_quatro = models.TextField(
        max_length=200, verbose_name='Descrição do quadrado 4', blank=True, null=True, default=' ')
    titulo_quadrado_cinco = models.CharField(
        max_length=50, verbose_name='Título do quadrado 5', blank=True, null=True, default=' ')
    descricao_quadrado_cinco = models.TextField(
        max_length=200, verbose_name='Descrição do quadrado 5', blank=True, null=True, default=' ')
